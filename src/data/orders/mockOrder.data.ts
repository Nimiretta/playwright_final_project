...
const customerWithNotes: ICustomerFromResponse = {
  ...
  _id: generateID(),
  createdOn: '2025-07-08T13:02:40.000Z',
};
...
export const mockData = [
  {
    tag: ['@001_O_CM_UI', TAGS.UI, TAGS.VISUAL_REGRESSION, TAGS.SMOKE],
    ...
    response: {
      Order: {
        ...
        history: [
          {
            status: ORDER_STATUSES.DRAFT,
            customer: customerWithNotes._id,
            products: [product],
            total_price: product.price,
            delivery: null,
  ...
  {
    tag: ['@002_O_CM_UI', TAGS.UI, TAGS.VISUAL_REGRESSION, TAGS.SMOKE],
